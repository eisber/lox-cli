...
Source: https://www.loxone.com/enen/kb/multifunction-switch/

---

Following a trigger, provides adjustable pulse at the output, includes permanent on and warning-function.
Before the output is deactivated again, a short switch off prewarning (on / off) takes place
...
| --- | --- | --- | --- |
| Tg | Toggle | Pulse at input switches output (O) on for the duration set in parameter (Don). Another pulse switches output (O) off again. Long-click = Switches output (O) permanently on. | 0/1 |
...
| Don | On-duration of output (O) on pulse | s | 0...∞ | 180 |
| Tlc | Time long-click for continious-on | Defines the duration of a long click to permanently switch on the output (O) via the input (Tr). | s | 0...∞ | 0,5 |
