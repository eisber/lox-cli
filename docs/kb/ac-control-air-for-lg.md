...
Source: https://www.loxone.com/enen/kb/ac-control-air-for-lg/
...
[**Datasheet AC Control Air for LG**](http://updatefiles.loxone.com/KnowledgeBase/Online/Common/Documents/Datasheet_ACControlAir_LG_100618.pdf)
...
Locate the 3-pole connector for the wired remote control in the LG indoor unit. If a remote control is connected, it must be disconnected and can no longer be used.

Connect the AC Control Air to the terminals with the enclosed connecting cable as follows:

![AcCont Connect LG](http://updatefiles.loxone.com/KnowledgeBase/Online/Common/Images/AcCont_Connect-LG.png)
