# Energy Meter for 40mA Current Transformers Tree

Source: https://www.loxone.com/enen/kb/energy-meter-for-40ma-current-transformers-tree/

---

This compact, DIN rail-mounted, MID-certified energy meter enables bidirectional measurement using three external 40 mA current transformers of your choice. It offers instant power outage detection and is ideal for energy management and monitoring in residential and commercial settings.

**[Datasheet Energy Meter for 40mA Current Transformers Tree](https://pim.loxone.com/datasheet/100694-energy-meter-for-40mA-ct-tree)**
...
After pairing the meter, the "Meter Type", "Type of use", as well as the "Primary Current" must be selected.
...
| Primary Current | Rated current on the primary side. Supported range: 5 A to 9999 A | ∞ | 1 |
...
**[Datasheet 40mA Current Transformers 100A 16mm](https://pim.loxone.com/datasheet/100680-40ma-current-transformers-100a-16mm)**

**[Datasheet 40mA Current Transformers 25A 10mm](https://pim.loxone.com/datasheet/100681-40ma-current-transformers-25a-10mm)**
