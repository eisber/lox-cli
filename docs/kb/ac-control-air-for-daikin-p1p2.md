# AC Control Air for Daikin P1P2

Source: https://www.loxone.com/enen/kb/ac-control-air-for-daikin-p1p2/
...
[**Datasheet AC Control Air for Daikin P1P2**](http://updatefiles.loxone.com/KnowledgeBase/Online/Common/Documents/Datasheet_ACControlAir_DaikinP1P2_100559.pdf)
...
Locate the screw terminals P1/P2 for the wired remote control in the Daikin indoor unit. If a remote control is connected, it must be disconnected and can no longer be used.

Connect the AC Control Air to the terminals with the enclosed connecting cable as follows:

![AcCont Connect P1P2](http://updatefiles.loxone.com/KnowledgeBase/Online/Common/Images/AcCont_Connect-P1P2.png)
