...
Source: https://www.loxone.com/enen/kb/meter-bidirectional/
...
| Mrc | Meter reading Consumption | Consumption Input for meters that send the meter reading directly as an analog value. For meters that only send partial quantities (e.g. Smart Socket), relative metering must be activated in the settings of the block. | 0...∞ |
| Mrd | Meter reading Delivery | Delivery Input for meters that send the meter reading directly as an analog value. For meters that only send partial quantities (e.g. Smart Socket), relative metering must be activated in the settings of the block. | 0...∞ |
...
| Abbreviation | Summary | Description | Value Range |
| --- | --- | --- | --- |
| Pf | Power or flow | Positive value: Energy is consumed. Negative value: Energy is delivered. | ∞ |
...
| --- | --- | --- |
| Power/Flow direction | Specifies whether the physical meter provides the delivery or consumption value as a positive or negative value to the Pf input of the block. | - |
