...
Source: https://www.loxone.com/enen/kb/miniserver-go/
...
[**Datasheet Miniserver Go**](http://updatefiles.loxone.com/KnowledgeBase/Online/Common/Documents/Datasheet_MiniserverGo_100336.pdf)
...
> **ℹ️ Note:** The Miniserver Go and Air signals can negatively influence each other when in close proximity. Therefore, a distance of 2 division / breaker units should be maintained between a Miniserver Go and an Air Base.
