...
Source: https://www.loxone.com/enen/kb/session-database-connector/
...
| --- | --- | --- | --- |
| SStart | Session start | Pulse at input triggers the start of a session and writes to the database, if configured. | 0/1 |
| SEnd | Session end | Pulse at input triggers the end of a session and writes to the database, if configured. | 0/1 |
