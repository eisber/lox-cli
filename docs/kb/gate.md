...
Source: https://www.loxone.com/enen/kb/gate/
...
## Inputs[↑](#ToC)
 ...
 | Tg 
 | Toggle 
 | Toggles between open, stop, close.
For single button control. 
 ...
 | T5 
 | T5 control 
 | Button 1: Complete open
Button 4: Complete close 
 | ∞ 
 ...
 | Off 
 | Off 
 | Pulse stops movement. On locks the block.
Dominating input.
The name of the connected sensor is used in the user interface. 
 ...
 | Disables inputs Tg, Co, Cc, T5 when On. (e.g Child lock, cleaning)
Control via user interface is still possible. 
 ...
 | Po 
 | Partially Open 
 | Moves door to partially open position if current position is different. 
 | 0/1 
...
## Properties[↑](#ToC)
 ...
 | Selection 
 | All selected Gate/Garage function blocks can be controlled together. 
 | - 
